    ...
    const RelayPanel = (props) => {
      ...
      const [showGuard, setShowGuard] = useState(false)
        ...
        const [protocolVersion, setProtocolVersion] = useState(() => {
          try {
            ...
            if (v === 'v1.6' || v === 'v1.7' || v === 'v1.8') return v
          } catch (e) { /* ignore */ }
          return 'v1.5'
        })
      ...
      useEffect(() => {
        ...
        fetch('/dsh-web-relay/protocol')
          ...
          .then((d) => { if (!cancelled && d && d.ok) setProtocol({ version: d.version, text: d.text, v16: d.protocolV16 || null, v17: d.protocolV17 || null, v18: d.protocolV18 || null, en: d.en || null }) })
      ...
      const packContext = async () => {
        ...
        try {
          ...
          const pickProtocol = (v15, v16, v17, v18) => {
          ...
          // v1.8: 优先取 protocolV18 全文，其次 v1.7 的 protocolV17，再 v1.6 的 protocolV16，退回 v1.5 protocol
          ...
          const lines = [
            ...
            protocolVersion === 'v1.8' ? T.protoV18Directive : protocolVersion === 'v1.7' ? T.protoV17Directive : protocolVersion === 'v1.6' ? T.protoV16Directive : T.protoV15Directive,
            ...protocolText.split('\n'),
            // v1.7 T5 / v1.8: 5 段式打包模板（v1.7/v1.8 注入：data_schema / pricing_map / mount_points / runtime_limits / history_trace，键名固定严禁省略）
            ...(protocolVersion === 'v1.7' || protocolVersion === 'v1.8' ? [
              '',
              '【' + T.tmplHeader + '】',
        ...
        h('div', { style: panelBodyStyle },
          ...
          protocol && h('div', { style: { display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 4, margin: '2px 0' } },
            h('div', { style: { display: 'flex', alignItems: 'center', gap: 6 } },
              ...
              }, (showProtocol ? T.protocolCollapse : T.protocolExpand) + ' ' + (protocolVersion === 'v1.8' && protocol.v18 ? 'v1.8' : protocolVersion === 'v1.6' && protocol.v16 ? 'v1.6' : protocolVersion === 'v1.7' && protocol.v17 ? 'v1.7' : 'v1.5'))
            ),
            showProtocol && h('div', { style: { ...preStyle, marginTop: 0, maxHeight: 160, fontSize: 12, width: '100%', boxSizing: 'border-box' } },
              (() => {
                ...
                const pick = protocolVersion === 'v1.8' && active.protocolV18 ? active.protocolV18
