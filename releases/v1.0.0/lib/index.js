      ...
      try {
        ...
        if (result === 'approved') {
          ...
          if (ready.length > 0) {
            ...
            // v1.5 线性唤醒（或 v1.6 就绪为 0）：找下一个 pending step 或 done 收口
