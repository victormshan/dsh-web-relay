 ...
 * （cc-quota-exhausted/cc-permission-denied/cc-timeout/cc-failed/v2-validate-failed）一致，
 * 关键词兜底（session limit/rate limit/quota、permissions to write/haven't granted/
 * not permitted）与 classifyCcFailure 的正则同源，避免两处正则各写一套却语义漂移。
 * 此前这三类 reason 落不到任何规则，一律归入 unknown（见 docs/CC-HYBRID.md 的
