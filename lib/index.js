...
import { recordCcOutcome, summarizeCcStats, loadStats, saveStats, classifyCcFailure } from './cc-stats.mjs'
...
export function apply(ctx) {
  ...
  async function collectHeavyHealth() {
    ...
    return { bridge, channelStats, restartStats, dialogFallbackRate, ccStats, selfCheck: lastSelfCheck || null }
  }
  ...
  const healthCheckHandler = async (req, res) => {
    ...
    json(res, 200, {
      ...
      channelStats,
      dialogFallbackRate,
      // v4.9.3（建议 #4）: cc 通道成功率统计（累积样本，回答"cc 通道到底稳不稳"）
